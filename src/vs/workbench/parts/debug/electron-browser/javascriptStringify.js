...
function isValidVariableName(name) {
	return (
		!RESERVED_WORDS.hasOwnProperty(name) && IS_VALID_IDENTIFIER.test(name)
	);
}
 ...
 * @return {string}
 */
function javascriptStringify(value, replacer, space, options) {
	options = options || {};
...
module.exports = javascriptStringify;
